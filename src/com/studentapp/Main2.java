...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		Student s1;
		s1 = new Student("Kevin Cooper", 22, "S-21");
		s1.enrollCourse("Java");
		s1.enrollCourse("Devops");
		s1.enrollCourse("DSA");
		s1.enrollCourse("C#");

		Student s2 = new Student("Uday Singh", 24, "S-11");
		s2.enrollCourse("Java");

		Student s3 = new Student("Anita Verma", 27, "S-13");
		s3.enrollCourse("Devops");

		Student s4 = new Student("Ajinkya Rahane", 22, "S-213");
